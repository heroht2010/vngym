...
<body>
   ...
   <div class="frame">
     ...
     <div class="menu">
      ...
      <div class="content">
       <p style="font-size: 25px;font-family: Montserrat;"><i class='fas fa-truck' style="margin-right: 1%"></i><b>DOANH THU</b></p>
       <p style="font-family: Montserrat;font-size: 18px">Thống kê đơn hàng vào</p>
       <form action="{{route('tkdoanhthu')}}" method="POST">
             @csrf
       ...
       <p style="font-family: Montserrat">Tổng doanh thu: <b id="doanhthu" style="font-size: 20px"></b></p>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td id="sum<?php echo $value['madh'] ?>"><?php echo $value->detaildonhang()->get()->first()->tongtien ?></td>
      ...
      <script type="text/javascript">
        ...
        var sum=$("#sum<?php echo $value['madh'] ?>").text();
        sum=sum.replace(/[^0-9\s]/gi, '')
        doanhthu=doanhthu+parseInt(sum);
      </script>
      <?php endforeach ?>
      <script type="text/javascript">
        $("#doanhthu").text(doanhthu+" VNĐ");
      </script>
    </tbody>
  </table>
      </div>
