...
<body>
    ...
    <a href="../GYMHTML/GYM-admin.php" class="hovermenu" style="
   text-decoration: none;"><i class="fa fa-dashboard" style="margin-right: 3%"></i>Dashboard</a>
    ...
    <div class="dropdown-container">
      <a href="../GYMHTML/list-productadmin.php" class="hovermenu" style="text-decoration: none;"><i class='fas fa-list-ol' style="margin-right: 3%;"></i>Danh sách</a>
      <a href="../GYMHTML/insert-productadmin.php" class="hovermenu" style="text-decoration: none;"><i class='fas fa-cart-plus' style="margin-right: 3%;"></i>Thêm</a>
    </div>
    ...
    <div class="dropdown-container">
      <a href="../GYMHTML/list-ptadmin.php" class="hovermenu" style="text-decoration: none;"><i class='fas fa-list-ol' style="margin-right: 3%;"></i>Danh sách</a>
      <a href="../GYMHTML/insert-ptadmin.php" class="hovermenu" style="text-decoration: none;"><i class=' fas fa-user-plus' style="margin-right: 3%;"></i>Thêm</a>
    </div>
   ...
   <a href="../GYMHTML/GYM-listpay.php" class="hovermenu" style="
   text-decoration: none;"><i class='fas fa-list-ol' style="margin-right: 3%"></i>Danh sách đơn hàng</a>
   <a href="../GYMHTML/GYM-doanhthu.php" class="hovermenu" style="
