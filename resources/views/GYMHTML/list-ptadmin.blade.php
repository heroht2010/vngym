...
@include("GYMHTML.navbar_admin")
   ...
   <div class="frame">
     ...
     <div class="menu">
      ...
      <div class="content">
       <p style="font-size: 25px;font-family: Montserrat;"><i class='fas fa-clipboard-list' style="margin-right: 1%"></i><b>DANH SÁCH PT</b></p>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td ><img src="../upload/pt/<?php echo $value['image'] ?>" style="height: 100px;width: 100px"></td>
        ...
        <td style="color: green"><i class="fa fa-refresh"></i><a href="{{route('editpt')}}?id=<?php echo $value['id']?>">Sửa</a></td>
        <td style="color: red"><i class="glyphicon glyphicon-trash"></i><a href="{{route('deletept')}}?id=<?php echo $value['id'] ?>">Xóa</a></td>
      </tr>
